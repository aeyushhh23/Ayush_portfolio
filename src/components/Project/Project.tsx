          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/aeyushhh23/AIChef" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="GitHub" />
                </a>
                 <a href="https://ai-chef-one.vercel.app/" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>AI Chef</h3>
              <p>
                AI Chef is an intelligent backend-driven system that generates personalized recipes based on user preferences, available ingredients, and dietary needs. It uses AI to suggest meals, optimize cooking steps, and enhance user experience with smart recommendations.
              </p>
            </div>
            <footer>
